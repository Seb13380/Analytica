...
class ImportStatementJob implements ShouldQueue
{
     ...
     * Retourne le nom avec sa civilité telle qu'imprimée sur le relevé.
     * Ex : "M ou Mme Christian Giordano", "M Christian Giordano"
     */
    private function extractHolderFromText(string $text): ?string
    {
        ...
        // Pour une succession on garde juste le nom sans civilité
        ...
        // ── Priorité 2 : en-tête des relevés (on scanne tout le texte,
        //    mais on prend la première ligne isolée qui correspond) ──────────
